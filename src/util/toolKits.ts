...
interface ToolKit{
    sortByPropertyName<T>(array: T[], property: keyof T, order: typeof ASC | typeof DESC): T[];
...
export const toolKit: ToolKit = {
    ...
    sortByPropertyName<T>(array: T[], property: keyof T, order: typeof ASC | typeof DESC = ASC): T[] {
        if (array.length === 0) {
            return array;
        }
        return array.sort((a, b) => {
    ...
    mapMusicFestivalArrayToRecordDtoArray(musicFestivalGroup: MusicFestival[]): RecordDto[] {
        ...
        recordBandGroupKeyValueMap.forEach((bandNameGroup, recordLabel) => {
            ...
            bandDtoGroupToStore = this.sortByPropertyName(bandDtoGroupToStore, 'bandName', ASC);
        ...
        recordDtoGroup = this.sortByPropertyName(recordDtoGroup, 'recordLabel', ASC);
